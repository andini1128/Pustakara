...
<head>
  ...
  <title>Masuk Admin - Pustakara</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .left-panel {
      width: 42%;
      background: linear-gradient(180deg, #d8ecfb 0%, #b9dcf3 100%);
      display: flex;
    ...
    .logo-mark {
      ...
      box-shadow: 0 18px 34px rgba(39, 121, 189, 0.14);
    }
    .logo-img {
      width: 118px;
      height: 118px;
    ...
    .brand-name {
      ...
      color: #123e7a; letter-spacing: 2px; text-transform: uppercase;
      line-height: 1.15;
    }
    .brand-sub {
      max-width: 240px;
    ...
    @media (max-width: 640px) {
      ...
      .left-panel { width: 100%; min-height: 220px; padding: 2rem 1.5rem; }
      .logo-mark { width: 128px; height: 128px; border-radius: 28px; }
...
<div class="login-card">
  ...
  <div class="right-panel">
    ...
    <form method="POST" action="{{ request()->routeIs('login.petugas') ? route('login.petugas.post') : route('login.post') }}">
      @csrf
