...
<head>
    ...
    <title>Favorit Buku - Pustakara</title>
...
<body>
    <main class="page">
        ...
        <section class="page-title">
            <h1>Buku Favorit</h1>
            <p>Total favorit: {{ $books->count() }} buku</p>
        </section>
                ...
                <article class="book-card">
                    ...
                    <div class="book-body">
                        ...
                        <form method="POST" action="{{ route('favorites.toggle', $book) }}" class="favorite-form">
                            @csrf
                            <button type="submit" class="remove-btn">Hapus dari Favorit</button>
                        </form>
                    </div>
                </article>
        ...
        @empty
            <div class="empty-state">
                Belum ada buku favorit. <a href="{{ route('koleksi.buku') }}">Pilih buku dari koleksi.</a>
            </div>
        @endforelse
    </main>
</body>
