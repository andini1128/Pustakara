...
<head>
    ...
    <title>Tambah Petugas - Pustakara</title>
    ...
    <div class="layout">
        ...
        <main class="content">
            <section class="form-card">
                ...
                <p>Masukkan data petugas baru untuk akun pengelola perpustakaan.</p>
                        ...
                        <div class="form-group full">
                            ...
                            <select id="alamat" name="alamat">
                                ...
                                @foreach ($bogorDistricts as $district)
                                    ...
                                    <option value="{{ $value }}" {{ old('alamat') === $value ? 'selected' : '' }}>{{ $district }}</option>
                                @endforeach
                            </select>
